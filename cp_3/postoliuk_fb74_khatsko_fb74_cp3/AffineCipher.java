...
public class AffineCipher {
    private static final String RUSSIAN_ALPHABET = "אבגדהוזחטיךכלםמןנסעףפץצקרשüû‎‏ÿ"; // There are no "¸", "ü".
    private static final int RUSSIAN_ALPHABET_LENGTH = 31;

    private static List<String> RUSSIAN_FREQUENTEST_BIGRAMS = List.of("סע", "םמ", "עמ", "םא", "ום");
